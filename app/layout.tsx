...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered mental health support with video therapy, voice calls, and text chat",
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${inter.className} min-h-screen flex flex-col bg-gradient-to-br from-blue-50/30 via-white/50 to-green-50/30 dark:from-blue-950/30 dark:via-gray-900/50 dark:to-green-950/30`}
      >
        <ConvexProvider>
