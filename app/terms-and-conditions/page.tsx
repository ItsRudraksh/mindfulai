    ...
    <div className="bg-background text-foreground min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-extrabold text-primary mb-4">Terms and Conditions</h1>
          <p className="text-sm text-muted-foreground mb-8">Last updated on Jun 30 2025</p>

          <div className="space-y-6 text-lg">
            <p>
              For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean Rudraksh Kapoor, whose registered/operational office is 1877, Sector-10, HUDA, Ambala City, HR, 134003 Ambala HARYANA 134003 . "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>You may not create a link to our website from another website or document without Rudraksh Kapoor's prior written consent.</li>
